...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "setting")) {
    if (message.author.id !== message.guild.owner.user.id)
      return message.channel.send(
        "**:closed_lock_with_key: لأسباب تتعلق بالحماية تم حصر أوامر الحماية فقط للأونر**"
      );
    if (message.content.startsWith(prefix +"setting limitsban")) {
    ...
    if (message.content.startsWith(prefix + "setting limitskick")) {
      if (!num) return message.channel.send("**:1234: | أرسل رقم ! **");
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
    ...
    if (message.content.startsWith(prefix + "setting limitsroleD")) {
      if (!num) return message.channel.send("**:1234: | أرسل رقم ! **");
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
    ...
    if (message.content.startsWith(prefix + "setting limitsroleC")) {
      if (!num) return message.channel.send("**:1234: | أرسل رقم ! **");
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
    ...
    if (message.content.startsWith(prefix + "setting limitschannelD")) {
      if (!num) return message.channel.send("**:1234: | أرسل رقم ! **");
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
    ...
    if (message.content.startsWith(prefix + "setting limitschannelC")) {
      if (!num) return message.channel.send("**:1234: | أرسل رقم ! **");
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
    ...
    if (message.content.startsWith(prefix + "setting limitstime")) {
      if (!num) return message.channel.send("**:1234: | أرسل رقم ! **");
      if (isNaN(num)) return message.channel.send("**:1234: | أرقام فقط ! **");
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "protection")) {
    if (message.author.id == message.guild.ownerID) {
      message.author
        .send(
          `  :closed_lock_with_key:  \**protection \** :closed_lock_with_key:   
          
 \**خلي رتبة البوت اعلى رتبة لحماية السيرفر بشكل كامل\**
**\`${prefix}setting limitsban\`** \**: تحدد العدد الي تبيه لو حد بند  البوت يبنده \**
**\`${prefix}setting limitskick\`** \** تحدد العدد الي تبيه لو حد طرد 3 او 4 البوت يبنده \**
**\`${prefix}setting limitsroleD\`** \**: تحدد العدد الي تبيه لو حد مسح رول 3 او 4 البوت يبنده \**
**\`${prefix}setting limitsroleC\`** \**: تحدد العدد الي تبيه لو حد صنع رول 3 او 4 البوت يبنده \**
**\`${prefix}setting limitschannelD\`** \**: تحدد العدد الي تبيه لو حد مسح روم 3 او 4 البوت يبنده \**
**\`${prefix}setting limitstime\`** \**: تحديد الوقت الذي من خلالة يتم التبنيد كـ مثال اذا شخص بند 5 في دقيقة البوت يبنده\**
